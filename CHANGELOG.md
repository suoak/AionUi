...
- **core:** pin AionCore v0.1.74 so existing 2.1.62 databases survive the 038/039 renumber
...
- 修复从旧版本升级到新版时，本地数据初始化失败、提示迁移状态异常的问题。已有会话和本地数据会保留，无需重装或重置。
...
### Core ([v0.1.74](https://github.com/suoak/AionCore/releases/tag/v0.1.74))

- **db:** remap branded 038/039 collisions so 0.1.70 databases can open

---

## [2.1.67](https://github.com/suoak/AionUi/compare/v2.1.66...v2.1.67) (2026-08-16)

### Desktop

#### Bug Fixes

- **core:** pin AionCore v0.1.73 so merged migrations no longer collide on a fresh database
...
### Core ([v0.1.73](https://github.com/suoak/AionCore/releases/tag/v0.1.73))
...
- **settings:** restore system-settings diagnostic logs after the upstream sync
...
## [2.1.64](https://github.com/suoak/AionUi/compare/v2.1.63...v2.1.64) (2026-08-16)

### Desktop

#### Bug Fixes

- **style:** format crash-recovery modal so the production tag can pass Code Quality
