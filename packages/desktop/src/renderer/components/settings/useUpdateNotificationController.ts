...
export const UPDATE_AVAILABLE_EVENT = 'csbu-workmate-update-available';
...
export const useUpdateNotificationController = () => {
  ...
  useEffect(() => {
    ...
    window.addEventListener('csbu-workmate-open-update-modal', handleWindowOpen);
    ...
    return () => {
      removeOpenListener();
      window.removeEventListener('csbu-workmate-open-update-modal', handleWindowOpen);
