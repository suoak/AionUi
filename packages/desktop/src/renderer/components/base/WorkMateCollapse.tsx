 ...
 */
export interface WorkMateCollapseProps {
 ...
 */
export interface WorkMateCollapseItemProps {
 ...
 */
const WorkMateCollapseItem: React.FC<WorkMateCollapseItemProps> = ({ children }) => <>{children}</>;
WorkMateCollapseItem.displayName = 'WorkMateCollapseItem';
 ...
 * ```tsx
 * // 基本用法 / Basic usage
 * <WorkMateCollapse defaultActiveKey={['1']}>
 *   <WorkMateCollapse.Item name="1" header="面板1">
 *     内容1
 *   </WorkMateCollapse.Item>
 *   <WorkMateCollapse.Item name="2" header="面板2">
 *     内容2
 *   </WorkMateCollapse.Item>
 * </WorkMateCollapse>
 *
 * // 手风琴模式 / Accordion mode
 * <WorkMateCollapse accordion defaultActiveKey="1">
 *   <WorkMateCollapse.Item name="1" header="面板1">内容1</WorkMateCollapse.Item>
 *   <WorkMateCollapse.Item name="2" header="面板2">内容2</WorkMateCollapse.Item>
 * </WorkMateCollapse>
 *
 * // 自定义图标 / Custom icon
 * <WorkMateCollapse
 ...
 * ```
 */
const WorkMateCollapseComponent: React.FC<WorkMateCollapseProps> & { Item: typeof WorkMateCollapseItem } = ({
  children,
  className,
  defaultActiveKey,
  activeKey,
  ...
  const items = useMemo(() => {
    return React.Children.toArray(children).filter((child): child is React.ReactElement<WorkMateCollapseItemProps> => {
      return React.isValidElement(child) && child.type === WorkMateCollapseItem;
    });
  }, [children]);
...
WorkMateCollapseComponent.Item = WorkMateCollapseItem;

export default WorkMateCollapseComponent;
