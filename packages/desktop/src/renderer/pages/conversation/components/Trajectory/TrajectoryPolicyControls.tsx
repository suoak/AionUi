...
type TrajectoryPolicyControlsProps = {
...
const TrajectoryPolicyControls: React.FC<TrajectoryPolicyControlsProps> = ({
  transcript,
  saving,
  onApprovalChange,
  onKeepNChange,
  ...
  return (
    <div data-testid='conversation-trajectory-policy' className='flex flex-col gap-12px'>
      <div className='flex flex-col gap-6px'>
        ...
        <Radio.Group
          ...
          disabled={saving}
          onChange={(value) => onApprovalChange(value === 'never' ? 'never' : 'ask')}
        >
      ...
      <div className='flex flex-col gap-6px'>
        ...
        <Select
          ...
          disabled={saving}
          onChange={(value) => onKeepNChange(Number(value))}
        >
