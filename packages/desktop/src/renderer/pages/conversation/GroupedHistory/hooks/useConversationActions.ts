...
export const useConversationActions = ({
  ...
  /**
   * Remove project state — rendered via WorkMateModal in the GroupedHistory component.
   * Uses project's design system: WorkMateModal component with danger-styled action button.
   */
