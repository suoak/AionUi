...
describe('MarkdownViewer', () => {
  ...
  it('keeps WorkMate markdown class and aionui-markdown CSS hook', () => {
    const { container } = render(<MarkdownViewer content='# Hello World' />);
    expect(container.querySelector('.csbu-workmate-markdown')).toBeTruthy();
    expect(container.querySelector('.aionui-markdown')).toBeTruthy();
  });
