...
function legacyConversation(type: 'gemini' | 'codex' | 'openclaw-gateway' | 'nanobot' | 'remote'): TChatConversation {
  return {
    ...
    type,
    model: {},
    extra: { workspace: '/tmp/csbu-workmate-history' },
    status: 'finished',
    source: 'csbu-workmate',
    created_at: 1,
    modified_at: 1,
    pinned: false,
        ...
        conversation={
          {
            ...
            type: 'acp',
            model: {},
            extra: { workspace: '/tmp/csbu-workmate-history', backend: 'claude' },
            status: 'finished',
            source: 'csbu-workmate',
            created_at: 1,
            modified_at: 1,
        ...
        conversation={
          {
            ...
            type: 'acp',
            model: {},
            extra: { workspace: '/tmp/csbu-workmate-history', backend: 'claude', current_model_id: 'model-1' },
            status: 'finished',
            source: 'csbu-workmate',
            created_at: 1,
            modified_at: 1,
